...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public DeviceInfoMesg() : base((Mesg) Profile.mesgs[Profile.DeviceInfoIndex])               
      {                 
      }
      ...
      public Types.BodyLocation? GetSensorPosition()   
      { 
         object obj = GetFieldValue(18, 0, Fit.SubfieldIndexMainField);
         Types.BodyLocation? value = obj == null ? (Types.BodyLocation?)null : (Types.BodyLocation)obj;
         return value;                     
      }
      ...
      public void SetSensorPosition(Types.BodyLocation? sensorPosition_) 
      {  
      ...
      public Types.AntNetwork? GetAntNetwork()   
      { 
         object obj = GetFieldValue(22, 0, Fit.SubfieldIndexMainField);
         Types.AntNetwork? value = obj == null ? (Types.AntNetwork?)null : (Types.AntNetwork)obj;
         return value;                     
      }
      ...
      public void SetAntNetwork(Types.AntNetwork? antNetwork_) 
      {  
      ...
      public Types.SourceType? GetSourceType()   
      { 
         object obj = GetFieldValue(25, 0, Fit.SubfieldIndexMainField);
         Types.SourceType? value = obj == null ? (Types.SourceType?)null : (Types.SourceType)obj;
         return value;                     
      }
      ...
      public void SetSourceType(Types.SourceType? sourceType_) 
      {  
