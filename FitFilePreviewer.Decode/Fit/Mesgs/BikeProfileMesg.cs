...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public BikeProfileMesg() : base((Mesg) Profile.mesgs[Profile.BikeProfileIndex])               
      {                 
      }
      ...
      public Types.Bool? GetAutoWheelCal()   
      { 
      ...
      public Types.Bool? GetSpdEnabled()   
      { 
      ...
      public void SetSpdEnabled(Types.Bool? spdEnabled_) 
      {  
      ...
      public Types.Bool? GetCadEnabled()   
      { 
      ...
      public Types.Bool? GetSpdcadEnabled()   
      { 
      ...
      public Types.Bool? GetPowerEnabled()   
      { 
