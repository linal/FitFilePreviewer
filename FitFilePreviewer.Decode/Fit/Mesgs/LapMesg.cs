...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public LapMesg() : base((Mesg) Profile.mesgs[Profile.LapIndex])               
      {                 
      }
      ...
      public Types.LapTrigger? GetLapTrigger()   
      { 
         object obj = GetFieldValue(24, 0, Fit.SubfieldIndexMainField);
         Types.LapTrigger? value = obj == null ? (Types.LapTrigger?)null : (Types.LapTrigger)obj;
         return value;                     
      }
      ...
      public void SetLapTrigger(Types.LapTrigger? lapTrigger_) 
      {  
