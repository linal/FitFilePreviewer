...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public EventMesg() : base((Mesg) Profile.mesgs[Profile.EventIndex])               
      {                 
      }
      ...
      public Types.TimerTrigger? GetTimerTrigger() 
      { 
         return (Types.TimerTrigger?)GetFieldValue(3, 0, DataSubfield.TimerTrigger);   
      }
      ...
      public Types.FitnessEquipmentState? GetFitnessEquipmentState() 
      { 
         return (Types.FitnessEquipmentState?)GetFieldValue(3, 0, DataSubfield.FitnessEquipmentState);   
      }
