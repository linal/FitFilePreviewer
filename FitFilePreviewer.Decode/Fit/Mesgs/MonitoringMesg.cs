...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public MonitoringMesg() : base((Mesg) Profile.mesgs[Profile.MonitoringIndex])               
      {                 
      }
      ...
      public Types.ActivitySubtype? GetActivitySubtype()   
      { 
         object obj = GetFieldValue(6, 0, Fit.SubfieldIndexMainField);
         Types.ActivitySubtype? value = obj == null ? (Types.ActivitySubtype?)null : (Types.ActivitySubtype)obj;
         return value;                     
      }
      ...
      public void SetActivitySubtype(Types.ActivitySubtype? activitySubtype_) 
      {  
      ...
      public Types.ActivityLevel? GetActivityLevel()   
      { 
         object obj = GetFieldValue(7, 0, Fit.SubfieldIndexMainField);
         Types.ActivityLevel? value = obj == null ? (Types.ActivityLevel?)null : (Types.ActivityLevel)obj;
         return value;                     
      }
      ...
      public void SetActivityLevel(Types.ActivityLevel? activityLevel_) 
      {  
