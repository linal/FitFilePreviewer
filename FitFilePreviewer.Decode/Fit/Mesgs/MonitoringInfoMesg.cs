...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public MonitoringInfoMesg() : base((Mesg) Profile.mesgs[Profile.MonitoringInfoIndex])               
      {                 
      }
      ...
      public Types.ActivityType? GetActivityType(int index)   
      { 
      ...
      public void SetActivityType(int index, Types.ActivityType? activityType_) 
      {  
