...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public LengthMesg() : base((Mesg) Profile.mesgs[Profile.LengthIndex])               
      {                 
      }
      ...
      public Types.LengthType? GetLengthType()   
      { 
         object obj = GetFieldValue(12, 0, Fit.SubfieldIndexMainField);
         Types.LengthType? value = obj == null ? (Types.LengthType?)null : (Types.LengthType)obj;
         return value;                     
      }
      ...
      public void SetLengthType(Types.LengthType? lengthType_) 
      {  
