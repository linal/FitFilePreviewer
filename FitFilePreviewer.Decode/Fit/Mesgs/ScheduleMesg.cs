...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public ScheduleMesg() : base((Mesg) Profile.mesgs[Profile.ScheduleIndex])               
      {                 
      }
      ...
      public Types.Bool? GetCompleted()   
      { 
      ...
      new public Types.Schedule? GetType()   
      { 
         object obj = GetFieldValue(5, 0, Fit.SubfieldIndexMainField);
         Types.Schedule? value = obj == null ? (Types.Schedule?)null : (Types.Schedule)obj;
         return value;                     
      }
      ...
      public void SetType(Types.Schedule? type_) 
      {  
