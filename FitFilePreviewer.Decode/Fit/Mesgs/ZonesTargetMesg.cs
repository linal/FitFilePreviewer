...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public ZonesTargetMesg() : base((Mesg) Profile.mesgs[Profile.ZonesTargetIndex])               
      {                 
      }
      ...
      public Types.HrZoneCalc? GetHrCalcType()   
      { 
         object obj = GetFieldValue(5, 0, Fit.SubfieldIndexMainField);
         Types.HrZoneCalc? value = obj == null ? (Types.HrZoneCalc?)null : (Types.HrZoneCalc)obj;
         return value;                     
      }
      ...
      public void SetHrCalcType(Types.HrZoneCalc? hrCalcType_) 
      {  
      ...
      public Types.PwrZoneCalc? GetPwrCalcType()   
      { 
         object obj = GetFieldValue(7, 0, Fit.SubfieldIndexMainField);
         Types.PwrZoneCalc? value = obj == null ? (Types.PwrZoneCalc?)null : (Types.PwrZoneCalc)obj;
         return value;                     
      }
      ...
      public void SetPwrCalcType(Types.PwrZoneCalc? pwrCalcType_) 
      {  
