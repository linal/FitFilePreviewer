...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public MesgCapabilitiesMesg() : base((Mesg) Profile.mesgs[Profile.MesgCapabilitiesIndex])               
      {                 
      }
      ...
      public void SetFile(Types.File? file_) 
      {  
      ...
      public Types.MesgCount? GetCountType()   
      { 
         object obj = GetFieldValue(2, 0, Fit.SubfieldIndexMainField);
         Types.MesgCount? value = obj == null ? (Types.MesgCount?)null : (Types.MesgCount)obj;
         return value;                     
      }
      ...
      public void SetCountType(Types.MesgCount? countType_) 
      {  
