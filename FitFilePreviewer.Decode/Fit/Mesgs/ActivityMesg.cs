...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public ActivityMesg() : base((Mesg) Profile.mesgs[Profile.ActivityIndex])               
      {                 
      }
      ...
      new public Types.Activity? GetType()   
      { 
         object obj = GetFieldValue(2, 0, Fit.SubfieldIndexMainField);
         Types.Activity? value = obj == null ? (Types.Activity?)null : (Types.Activity)obj;
         return value;                     
      }
      ...
      public void SetType(Types.Activity? type_) 
      {  
