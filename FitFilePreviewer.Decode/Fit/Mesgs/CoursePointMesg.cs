...
namespace FitFilePreviewer.Decode.Fit.Mesgs
{
   ...
   {    
      ...
      #region Constructors                 
      public CoursePointMesg() : base((Mesg) Profile.mesgs[Profile.CoursePointIndex])               
      {                 
      }
      ...
      new public Types.CoursePoint? GetType()   
      { 
         object obj = GetFieldValue(5, 0, Fit.SubfieldIndexMainField);
         Types.CoursePoint? value = obj == null ? (Types.CoursePoint?)null : (Types.CoursePoint)obj;
         return value;                     
      }
      ...
      public void SetType(Types.CoursePoint? type_) 
      {  
