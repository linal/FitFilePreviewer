...
namespace FitFilePreviewer.Decode.Fit
{
   ...
   public static class Profile
   {
      ...
      {                                                             
         ...
         fieldIndex++;
         recordMesg.SetField(new Field("Cycles", 18, 2, 1f, 0f, ""));                   
         ...
         fieldIndex++;
         recordMesg.SetField(new Field("CompressedAccumulatedPower", 28, 132, 1f, 0f, ""));                   
         ...
         subfieldIndex++;
         eventMesg.fields[fieldIndex].subfields.Add(new Subfield("SpeedHighAlert", 132, 1000f, 0f, "m/s"));
         eventMesg.fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 15);
         subfieldIndex++;
         eventMesg.fields[fieldIndex].subfields.Add(new Subfield("SpeedLowAlert", 132, 1000f, 0f, "m/s"));
         ...
         fieldIndex = 0;
         monitoringInfoMesg.SetField(new Field("Timestamp", 253, 134, 1f, 0f, ""));
         fieldIndex++;
         monitoringInfoMesg.SetField(new Field("LocalTimestamp", 0, 134, 1f, 0f, ""));
         fieldIndex++;
