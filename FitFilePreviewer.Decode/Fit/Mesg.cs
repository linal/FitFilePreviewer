...
namespace FitFilePreviewer.Decode.Fit
{
   ...
   public class Mesg
   {
      ...
      internal Mesg(ushort mesgNum) : this((Mesg) Profile.GetMesg(mesgNum))
      {         
      }
      ...
      public FitFilePreviewer.Decode.Fit.Types.DateTime TimestampToDateTime(uint timestamp)
      {
          FitFilePreviewer.Decode.Fit.Types.DateTime dateTime = new FitFilePreviewer.Decode.Fit.Types.DateTime(timestamp);
      ...
      public FitFilePreviewer.Decode.Fit.Types.DateTime TimestampToDateTime(uint? timestamp)
      {
          FitFilePreviewer.Decode.Fit.Types.DateTime dateTime = new FitFilePreviewer.Decode.Fit.Types.DateTime(timestamp ?? 0);
         dateTime.ConvertSystemTimeToUTC(systemTimeOffset);
