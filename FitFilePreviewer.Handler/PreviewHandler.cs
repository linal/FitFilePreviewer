...
namespace FitFilePreviewer.Handler
{
    public abstract class PreviewHandler : IPreviewHandler, IPreviewHandlerVisuals, IOleWindow, IObjectWithSite
    {
        ...
        {
            Debug.WriteLine(string.Format("PreviewHandler() {0}", DateTime.Now));
        ...
        {
            Debug.WriteLine(string.Format("DoPreview: {0}", DateTime.Now));
        ...
        public static void Register(Type t)
        {
            if (t != null && t.IsSubclassOf(typeof(PreviewHandler)))
            {
                ...
                if (attrs != null && attrs.Length == 1)
                {
                    ...
                    Debug.WriteLine("Register: {0} {1} {2} {3}", attr.Name, attr.Extension, t.GUID.ToString("B"), attr.AppId);
